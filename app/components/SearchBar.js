...
const SearchBar = () => {
  return (
    <div className='w-full bg-background h-[40vh] flex items-center justify-center relative'>
        ...
        <input className='bg-background text-textPrimary border-[1px] border-border absolute w-96 h-10 rounded-md px-3 opacity-80' type="text" />
        <button className='bg-primary active:bg-secondary border-border border-[1px] absolute w-40 h-10 rounded-md text-md bottom-14 text-textPrimary'>Search</button>
